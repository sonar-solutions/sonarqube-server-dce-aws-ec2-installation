...
This script reads terraform.tfvars.json file (or creates it from terraform.tfvars.json.sample 
...
2. If not found, use terraform.tfvars.json.sample as a template
...
def determine_source_file() -> str:
    ...
    Exits:
        If neither terraform.tfvars.json nor terraform.tfvars.json.sample exists
    """
    variables_file = 'terraform.tfvars.json'
    example_file = 'terraform.tfvars.json.sample'
